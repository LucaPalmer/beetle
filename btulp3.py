...
# -*- coding: utf-8 -*-
"""
Created on Wed Mar  3 15:36:56 2021
...
def body_2():
    ...
    if result_2 == 1:
        if result_2 in dice_order:
            player_2.insert(0, dice_order[result_2])
...
def head_2():
    result_2 = 2
    if result_2 in dice_order:  
        if result_2 == 2 or result_2 == 6:
            player_2.insert(1, dice_order[result_2])
...
def beetle():        
    ...
    dice_counter += 1
    player.sort()
    rotation = {1: body, 2: head, 3: antennae, 4: eye, 
                5: mouth, 6: leg}
