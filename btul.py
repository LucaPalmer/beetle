...
def beetle():
    ...
    input("""Welcome to Beetle! Here are the rules: The aim is to collect all the body parts of a beetle. A dice roll of 1 gives a beetle body, 2 gives a head, 3 gives an antenna, 4 gives an eye, 5 gives a mouth, and 6 gives a leg. 
...
\nPress Enter to Roll the Dice!\n """) 
    ...
    if len(player) == 13:
        print("Congratulations, you won! Press Enter to Close")
        return()
